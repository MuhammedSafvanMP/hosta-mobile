...
//     final mapUrl = "https://www.google.com/maps?q=${hospital["latitude"]},${hospital["longitude"]}";
...
//                   if (specialty["doctors"] != null && (specialty["doctors"] as List).isNotEmpty)
//                     Padding(
//                       padding: const EdgeInsets.only(top: 8),
//                       child: Column(
//                         crossAxisAlignment: CrossAxisAlignment.start,
...
//                           ...(specialty["doctors"] as List).take(2).map((doctor) => Padding(
...
//                             ),
//                           )).toList(),
//                           if ((specialty["doctors"] as List).length > 2)
//                             Padding(
//                               padding: const EdgeInsets.only(top: 2),
//                               child: Text(
//                                 "+ ${(specialty["doctors"] as List).length - 2} more doctors",
//                                 style: const TextStyle(
//                                   fontSize: 10,
//                                   color: Colors.green,
...
//   // ===================== LOCATION TAB =====================
//   Widget _buildLocationTab(String mapUrl) {
//     return _LocationWebView(mapUrl: mapUrl);
//   }
...
// // 🌐 WebView Tab Widget
// class _LocationWebView extends StatefulWidget {
//   final String mapUrl;
//   const _LocationWebView({required this.mapUrl});

//   @override
//   State<_LocationWebView> createState() => _LocationWebViewState();
// }

// class _LocationWebViewState extends State<_LocationWebView> {
