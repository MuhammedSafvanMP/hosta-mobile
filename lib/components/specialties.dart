...
// // // import '../data/specialty_data.dart'; // Import your data file
...
// // //     final filteredData = specialtyData.entries
...
// // //                       return _buildCard(name, imageUrl, width);
// // //                     },
// // //                   ),
// // //                 ),
// // //               ),
...
// // // import 'package:flutter/material.dart';
// // // import '../data/specialty_data.dart';
...
// // //                         onTap: () => _showHospitalPopup(context, name),
...
// // //     final hospitals = hospitalData[specialtyName.toLowerCase()] ?? [];
...
// // //                             backgroundImage: NetworkImage(h["image"]),
// // //                             radius: 26,
// // //                           ),
// // //                           title: Text(
// // //                             h["name"],
...
// // //                             children: [
// // //                               Text("⭐ ${h["rating"]}  |  ${h["location"]}"),
// // //                               Text("👨‍⚕️ Doctors: ${h["doctorsCount"]}"),
// // //                             ],
// // //                           ),
// // //                         ),
// // //                       );
...
// //                         return _buildHospitalCard(hospital, specialtyName);
// //                       },
// //                     ),
// //                   ),
// //               ],
...
// //   Widget _buildHospitalCard(Map<String, dynamic> hospital, String specialtyName) {
...
// //         leading: _buildHospitalAvatar(imageUrl),
// //         title: Text(
// //           hospitalName,
// //           style: const TextStyle(
// //             fontSize: 16,
...
// //             Text(
// //               "👨‍⚕️ $specialtyDoctorsCount ${specialtyName.toLowerCase()} doctors",
// //               style: const TextStyle(
// //                 fontSize: 13,
// //                 fontWeight: FontWeight.w500,
// //                 color: Colors.green,
...
// //         onTap: () {
// //           // Add navigation to hospital details if needed
// //           print("Hospital tapped: $hospitalName");
// //         },
// //       ),
// //     );
// //   }
...
// //           // This callback is only called when the backgroundImage fails to load
// //           print("Image loading error: $exception");
// //         },
// //         child: const Icon(Icons.local_hospital, size: 24, color: Colors.white),
// //       );
// //     } else {
// //       return CircleAvatar(
...
//                     Row(
//                       children: [
//                         Icon(Icons.people_alt_outlined, size: 14, color: Colors.blue),
//                         const SizedBox(width: 4),
//                         Text(
//                           "$totalDoctorsCount total doctors",
//                           style: const TextStyle(
