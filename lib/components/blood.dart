...
// //       print("👤 User Data - UserId: $userId, BloodId: $bloodId");
// //     } catch (e) {
...
// //       final response = await api.getAllDonors();
// //       final donorList = response.data['donors'] ?? [];
...
// //             ),
// //             const Center(
// //               child: Text("Blood Donor Connect",
...
// //               ),
// //             ] else ...[
// //               // Optional: Show registered status (you can remove this if you want nothing)
// //               Container(
// //                 padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 12),
...
//       print("🔄 Fetching donors from API...");
//       final response = await api.getAllDonors();
...
//         print("📍 States: $states");
//       } else {
//         print("❌ Failed to fetch donors. Status: ${response.statusCode}");
//         setState(() {
//           donors = [];
//         });
//       }
...
class _BloodState extends State<Blood> {
  ...
  Future<void> _fetchDonors() async {
    try {
      ...
      print("🔄 Fetching donors from API...");
      final response = await _apiService.getAllDonors(); // Use direct instance
