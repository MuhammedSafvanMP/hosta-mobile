...
// //       final donorRes = await _apiService.getADonor(userId);

// //       setState(() {
// //         userData = userRes.data?['data'] ?? userRes.data ?? {};
        
// //         if (donorRes.data is List) {
// //           donorData = donorRes.data.isNotEmpty ? donorRes.data[0] : null;
// //         } else {
...
// //     if (!isEditing) return; // Only allow image pick in edit mode
...
// //       ScaffoldMessenger.of(context).showSnackBar(
// //         const SnackBar(content: Text("Donor record deleted successfully")),
// //       );
...
// //               children: [
// //                 GestureDetector(
// //                   onTap: isEditing ? _pickImage : null, // Only allow tap in edit mode
// //                   child: CircleAvatar(
// //                     radius: 50,
...
// //     if (donorData == null || donorData!.isEmpty) {
// //       return const SizedBox.shrink();
// //     }

// //     final address = donorData?['address'] ?? {};
    
// //     // Check if donor data has meaningful content - FIXED NULL CHECKS
...
// //             // Blood Group - Only show if available
// //             if (hasBloodGroup)
...
// //             // Address Section - Only show if address data exists
// //             if (hasAddressData) ...[
...
// //               // Only show address fields that have data - FIXED NULL CHECKS
...
// //         children: [
// //           SizedBox(
// //             width: 100, // Fixed width for labels to prevent overflow
// //             child: Text(
// //               "$label: ",
...
//   // Load user ID first, then load profile
...
//   Widget _buildDonorSection() {
//     // Don't show donor section if no user ID
//     if (userId == null || userId!.isEmpty) {
//       return const SizedBox.shrink();
//     }
...
//     // Check if donor data has meaningful content
//     final hasBloodGroup = donorData?['bloodGroup'] != null && 
//                          donorData!['bloodGroup'].toString().isNotEmpty;
...
//               // Only show address fields that have data
//               if (address['country'] != null && address['country']!.toString().isNotEmpty)
//                 _buildDonorDetail("Country", _safeToString(address['country'])),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          icon: const Icon(Icons.arrow_back_ios_new, color: Colors.white), // Changed to arrow_back_ios_new
          onPressed: () => Navigator.pop(context),
        ),
      ),
      body: isLoading
